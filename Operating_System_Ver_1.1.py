...
while y == 0:
    ...
    if user_input == "halt" or user_input == "khamoosh" or user_input == "shutdown" or user_input == "poweroff" or user_input == "off":
        print("See you later...")
        break
    elif user_input == "cls" or user_input == "clear" or user_input == "pak":
        os.system("cls")
